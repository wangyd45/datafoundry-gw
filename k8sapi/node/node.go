...
//v1.Node
//router.POST("/api/v1/nodes", route.CreateNode)
//router.GET("/api/v1/nodes/:name", route.GorWNode)
//router.GET("/api/v1/nodes", route.GorWAllNodes)
//router.PUT("/api/v1/nodes/:name", route.UpdateNode)
//router.PATCH("/api/v1/nodes/:name", route.PatchNode)
//router.DELETE("/api/v1/nodes/:name", route.DeleteNode)
//router.DELETE("/api/v1/nodes", route.DeleteAllNodes)
//router.GET("/api/v1/nodes/:name/status", route.GetStatusOfNode)
//router.PUT("/api/v1/nodes/:name/status", route.UpdateStatusOfNode)
//router.PATCH("/api/v1/nodes/:name/status", route.PatchStatusOfNode)
//router.OPTIONS("/api/v1/nodes/:name/proxy",route.ProxyOpnReqToNode)
//router.POST("/api/v1/nodes/:name/proxy",route.ProxyPostReqToNode)
//router.HEAD("/api/v1/nodes/:name/proxy",route.ProxyHeadReqToNode)
//router.GET("/api/v1/nodes/:name/proxy",route.ProxyGetReqToNode)
//router.PUT("/api/v1/nodes/:name/proxy",route.ProxyPutReqToNode)
//router.PATCH("/api/v1/nodes/:name/proxy",route.ProxyPatchReqToNode)
//router.DELETE("/api/v1/nodes/:name/proxy",route.ProxyDelReqToNode)
//router.OPTIONS("/api/v1/nodes/:name/proxy/:path",route.ProxyOpnReqToNodeP)
//router.POST("/api/v1/nodes/:name/proxy/:path",route.ProxyPostReqToNodeP)
//router.HEAD("/api/v1/nodes/:name/proxy/:path",route.ProxyHeadReqToNodeP)
//router.GET("/api/v1/nodes/:name/proxy/:path",route.ProxyGetReqToNodeP)
//router.PUT("/api/v1/nodes/:name/proxy/:path",route.ProxyPutReqToNodeP)
//router.PATCH("/api/v1/nodes/:name/proxy/:path",route.ProxyPatchReqToNodeP)
//router.DELETE("/api/v1/nodes/:name/proxy/:path",route.ProxyDelReqToNodeP)